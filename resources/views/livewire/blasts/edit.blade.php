<div>
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-xl font-semibold text-gray-900">Edit Blast Schedule</h1>
        </div>
        ...
        <form wire:submit="update" class="p-6 space-y-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="mt-1 text-sm text-yellow-700">
                                You need to connect a WhatsApp device before editing a blast.
            ...
            <div>
                ...
                <div class="mt-1">
                    @if($hasExistingMedia && !$media)
                        <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                            <svg class="h-8 w-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                            </svg>
                            <div class="ml-3 flex-1">
                                <p class="text-sm font-medium text-gray-900">Current attachment</p>
                                <p class="text-sm text-gray-500">{{ basename($blast->media_path) }}</p>
                            </div>
                            <button
                                type="button"
                                wire:click="removeCurrentMedia"
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button
                    ...
                    {{ $devices->isEmpty() ? 'disabled' : '' }}
                >
                    <span wire:loading.remove wire:target="update">Update Blast</span>
